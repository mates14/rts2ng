...
class Daemon:public Block
{
	public:
		 ...
		 * @see PROTO_STATUS
		 */
		void sendStatusMessage (rts2_status_t state, const char * msg = nullptr, Connection *commandedConn = nullptr);
	...
	protected:
		 ...
		 */
		void maskState (rts2_status_t state_mask, rts2_status_t new_state, const char *description = nullptr, double start = NAN, double end = NAN, Connection *commandedConn = nullptr);
