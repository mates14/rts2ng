/*
 * Log stream, used for logging output.
 ...
 * processing.
 *
 * If no App is registered yet (masterApp == nullptr), sendLog() falls back
 * to stderr - this lets anything lower in the stack (IniParser, Value, ...)
 * log usefully before/without a full App existing.
 *
 * @ingroup RTS2Block
 *
