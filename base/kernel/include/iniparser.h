...
// base note: the classic tree included "value.h" here, but nothing in
// IniValue/IniSection/IniParser actually names rts2core::Value - verified by
// grep. Dropped; IniParser no longer pulls in the Value type system at all.
...
class IniParser: public std::vector < IniSection * >
{
	public:
		...
		int loadFile (const char *filename = nullptr, bool parseFullLine = false);
