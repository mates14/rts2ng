...
// base note: x/y/w/h were raw owning pointers in the classic tree, deleted
// by hand in the destructor. Same pattern as the LibnovaRaDec bug fixed
// earlier in libnova_cpp.h - switched to unique_ptr so a future copy of this
// class can't double-free (no copy operations are defined here currently,
// so this is prevention rather than a fix for an observed bug).
