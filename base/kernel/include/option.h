...
// base note: the classic header fell back to a bundled getopt_own.h when
// RTS2_HAVE_GETOPT_LONG wasn't defined - modern glibc always has
// getopt_long, so that fallback is dropped.
