...
// base note: classic tree has this at include/connection/ethernet.h -
// flattened to kernel/include/connethernet.h, same convention as
// connudp.h/connserial.h. Opens a raw AF_PACKET/SOCK_RAW socket in init()
// - requires CAP_NET_RAW (root, in practice) even just to call socket().
// Cannot be smoke-tested for real network I/O on this development machine
// (no root); init() failing cleanly with EPERM is the extent of what can
// be verified here.
