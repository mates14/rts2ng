...
// base note: classic tree has this at include/rts2fits/devcliimg.h -
// flattened to kernel/include/devcliimg.h, same convention as
// fitsfile.h/channel.h/image.h/cameraimage.h. The optional
// ImageMagick/libjpeg preview-saving path (classic
// `#ifdef RTS2_HAVE_LIBJPEG` fields/code in DevClientCameraImage) is
// dropped entirely, same reasoning as image.h - no Magick++/libjpeg
// dependency anywhere in base, and it's cosmetic (JPEG preview
// generation), not needed by execcli/scriptexec.
