/*
 * Message class - carries log/status text through the system.
...
// base note: the classic tree #included "block.h" here purely for the
// PROTO_MESSAGE string constant - extracted to proto.h instead, since Block
// doesn't exist yet in base and Message has no other reason to depend on it.
#include "message.h"
#include "proto.h"
...
{
	gettimeofday (&messageTime, nullptr);
