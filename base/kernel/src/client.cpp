...
// base note: dropped the classic tree's #include <rts2-config.h> in favor
// of base-config.h (needed for RTS2_CENTRALD_PORT, same pattern as
// device.cpp/daemon.cpp).
