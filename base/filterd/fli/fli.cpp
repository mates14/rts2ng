...
// base note: same situation as focusd/fli - see that file's base note.
...
int Fli::homeFilter ()
{
	return setFilterNum (defaultFilterPosition != nullptr? defaultFilterPosition->getValueInteger () : FLI_FILTERPOSITION_HOME);
}
