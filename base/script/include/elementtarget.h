...
// base note: classic tree unconditionally #includes elementacquire.h
// here even though nothing in this file references ElementAcquire - that
// header itself is DB-free, but its .cpp (needing ConnImgProcess/
// rts2db::Observation) is the one genuine DB dependency in the whole
// scriptexec closure, deliberately dropped for this port (user-confirmed
// - see UPSTREAM_BUGS.md-adjacent STATUS.md "Scriptexec push" section).
// The include is dropped here since it's unused in this file anyway.
