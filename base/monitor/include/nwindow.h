...
// base note: classic tree autoconf-detected which of <curses.h> /
// <ncurses/curses.h> was available. Modern Linux ncurses-dev always
// installs <curses.h> at the top include level - use it directly.
#include <curses.h>
