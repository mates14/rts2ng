...
// base note: classic tree has this at include/connection/ford.h - it's
// rts2core-namespaced but specific to the Ford dome-control board, so it
// lives in the dome driver family (base/dome/include/) rather than the
// kernel, same convention as teld/include/connremotes.h.
