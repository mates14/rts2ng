...
// base note: source of truth classic include/tpointmodel.h +
// lib/rts2tel/tpointmodel.cpp - see tpointmodelterm.h's base note for why
// this is being ported now (a real T-Point model file, t0-191230.mod, is
// in active use).
