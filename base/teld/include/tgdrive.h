...
// base note: classic tree has this at include/connection/tgdrive.h -
// flattened here (matching how connserial.h/connudp.h were flattened in
// the kernel), but placed in base/teld/ rather than the kernel since it's
// specific to the D50 mount's servo controllers, not generic bus
// infrastructure, despite being namespaced rts2teld like the rest of teld.
