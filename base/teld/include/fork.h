...
// base note: ported faithfully (no redesign) - see the GEM/Fork/AltAz
// hierarchy discussion in STATUS.md. Fork is HA/Dec equatorial with a
// simpler flip handling than GEM (no flip-preference/trajectory-safety
// machinery); the user's call was to port this as-is now (D50 only needs
// Fork) and revisit merging GEM+Fork into one equatorial-axis class with
// flip-strategy-as-property once a real GEM driver is also on the table.
