...
void SqlQuery::display ()
{
	...
	while (1)
	{
		// base note: classic file branched on RTS2_HAVE_PGSQL_9 between
		// quoted/unquoted descriptor-name syntax; the unquoted form predates
		// the SQL-standard syntax and modern ecpg (>=9) always wants it
		// quoted, so the old branch is dropped as dead on any current
		// PostgreSQL install.
