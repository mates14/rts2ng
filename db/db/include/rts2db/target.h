...
// db note: classic tree had a `TargetPlan:public Target` here, backed by
// a `Plan`/`PlanSet` DB-persisted target-chaining feature. Confirmed (user,
// 2026-07-15) to be dead/superseded by the Python queuer - "desperately
// failed" in practice at the one site it was tried - and removed entirely
// as part of the executor-lite pass (see rts2_executor_lite_plan memory).
